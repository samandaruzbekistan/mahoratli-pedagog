    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-2 col-md-6 single-footer-widget">
                <h4>BOBLAR</h4>
                <ul>
                    <li><a href="#">I BOB</a></li>
                    <li><a href="#">II BOB</a></li>
                    <li><a href="#">III BOB</a></li>
                    <li><a href="#">IV BOB</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-6 single-footer-widget">
                <h4>Bo'limlar</h4>
        ...
        <div class="row footer-bottom">
            <p class="col-lg-8 col-sm-12 footer-text m-0 text-white">
                ...
                Barcha huquqlar himoyalangan | Ishlab chiquvchi: <a href="https://t.me/Samandar_developer" target="_blank">Gold Apps IT
                    company</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
