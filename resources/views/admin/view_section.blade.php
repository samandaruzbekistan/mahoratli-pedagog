            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">{{ $section->name }} - qism mavzulari</h5>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>{{ $section->name }}</td>
                                <td>
                                    <a href="{{ route('theme.topic.view', ['theme_id' => $section->id]) }}"
                                ...
                                <td>
                                    <a href="{{ route('admin.theme.quizzes', ['theme_id' => $section->id]) }}"
